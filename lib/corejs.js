...
(function (Carbon) {
    ...
    function observe(observable, type, handler, useCapture) {
        return new Observer(observable, type, handler, useCapture);
    }
    Carbon.observe = observe;
    var Reactive = (function () {
        ...
        Reactive.prototype.drain = function () {
            this.mode = null;
    ...
    Carbon.ActionKit = {
        ...
        _execute: function (e, action) {
            ...
            if (!func)
                throw new Error("Action#" + controllerName + ":" + actionName + " not registered");
            func(e);
        }
    };
...
(function (_) {
    ...
    function one(element, type, listener) {
        ...
        var observer = new EventHandler(element, type, func, false);
    }
    _.one = one;
